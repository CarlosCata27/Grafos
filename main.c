...
int main()
{
    ...
    Vertice vertices[] = {
            {0,1,75},{1,2,62},{2,3,58},{3,4,55},{4,5,95},{5,6,110},{6,7,87},{7,8,93},{8,9,118},{9,10,82},{11,12,63},{12,13,53},{13,14,60},{14,15,43},
            {15,16,55},{16,17,62},{17,5,59},{5,18,75},{18,19,108},{19,20,80},{21,22,122},{22,14,110},{14,23,50},{23,2,68},{2,24,85},{24,25,74},
            {25,26,87},{27,28,62},{28,7,45},{7,29,65},{29,30,64},{30,31,65},{32,15,70},{15,33,60},{33,3,73},{3,34,68},{34,35,77},{35,19,82},{19,36,90},
            {36,31,63},{37,26,107},{26,38,75},{38,19,110},{19,30,90},{39,22,110},{22,32,115},{32,40,100},{40,41,80},{41,28,75},{28,8,83}
    };
    ...
    for (int i = 0; i < 42 ; ++i) {
        pesos[vertices[i].src][vertices[i].dest] = vertices[i].segundos;
    }
